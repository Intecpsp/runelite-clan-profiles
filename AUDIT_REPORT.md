...
This document is the **standardized source of truth** for all **289 unique external plugins** installed across your **8 active RuneLite profiles** (`default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`). Every single plugin entry has the exact same 4 metadata fields: **Active Profiles**, **GitHub Repository**, **Last Updated on GitHub**, and **Function Summary**.

### 1. `abc-alch` (Abc Alch)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
| **`Slayer`** | `Slayer-1.properties` | **189** | **Slayer & Combat Tasks:** Base QoL + 38 Shared PvM Combat plugins + `slayer-boosting`. |
...
## 🧩 1. Master Base QoL Plugins (`default-0.properties` - 147 Plugins)
### 1. `117hd` (117hd)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 4. `another-bronzeman-mode` (Another Bronzeman Mode)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 6. `bank-equipment-stat-filter` (Bank Equipment Stat Filter)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 7. `bank-multisearch` (Bank Multisearch)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 8. `bank-organizer` (Bank Organizer)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 9. `bank-slot-sync` (Bank Slot Sync)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 10. `bank-tag-layouts` (Bank Tag Layouts)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 11. `banked-experience` (Banked Experience)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 12. `better-npc-highlight` (Better Npc Highlight)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 13. `better-skill-tooltips` (Better Skill Tooltips)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 15. `birdhouse-overlay` (Birdhouse Overlay)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 16. `birdhouse-status` (Birdhouse Status)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 18. `boat-upgrades` (Boat Upgrades)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 21. `c-engineer-completed` (C Engineer Completed)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 22. `camera-smoothing` (Camera Smoothing)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 23. `center-skill-icons` (Center Skill Icons)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 24. `chat-scroll-lock` (Chat Scroll Lock)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 25. `chatbox-opacity` (Chatbox Opacity)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 27. `clan-chat-country-flags` (Clan Chat Country Flags)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 28. `clan-event-attendance` (Clan Event Attendance)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 29. `clan-rank-up-notifier` (Clan Rank Up Notifier)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 31. `click-minimap-orbs` (Click Minimap Orbs)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 33. `clue-scroll-juggling` (Clue Scroll Juggling)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 34. `clue-scroll-notifier` (Clue Scroll Notifier)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 36. `clue-teleport-helper` (Clue Teleport Helper)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 37. `collection-log` (Collection Log)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 38. `collection-log-luck` (Collection Log Luck)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 39. `compass-camera-control` (Compass Camera Control)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 40. `cooking-buddy` (Cooking Buddy)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 41. `corner-tile-indicators` (Corner Tile Indicators)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 43. `customizable-xp-drops` (Customizable Xp Drops)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 44. `decimal-prices` (Decimal Prices)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 45. `default-minimap-zoom` (Default Minimap Zoom)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 46. `did-i-compost` (Did I Compost)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 48. `discord-collection-logger` (Discord Collection Logger)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 49. `drop-party-chest` (Drop Party Chest)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 50. `duck-duck-goose` (Duck Duck Goose)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 51. `dude-wheres-my-stuff` (Dude Wheres My Stuff)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 52. `easy-pharaoh-sceptre` (Easy Pharaoh Sceptre)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 53. `effective-level` (Effective Level)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 54. `elysiumevents-plugin` (Elysiumevents Plugin)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 55. `emote-clue-items` (Emote Clue Items)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 56. `equipment-inspector` (Equipment Inspector)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 57. `event-scouting` (Event Scouting)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 58. `fixed-resizable-hybrid` (Fixed Resizable Hybrid)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 60. `fossil-island` (Fossil Island)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 61. `friends-house` (Friends House)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 63. `fuzzy-bank-search` (Fuzzy Bank Search)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 65. `goggles-reminder` (Goggles Reminder)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 68. `high-alc-highlight` (High Alc Highlight)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 69. `highlight-stackable-items` (Highlight Stackable Items)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 70. `hot-cold-helper` (Hot Cold Helper)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 71. `improved-tile-indicators` (Improved Tile Indicators)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 72. `instant-inventory` (Instant Inventory)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 73. `inventory-setups` (Inventory Setups)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 74. `kill-count-viewer` (Kill Count Viewer)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 76. `last-seen-online` (Last Seen Online)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 77. `location-display` (Location Display)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 78. `lootbag-utilities` (Lootbag Utilities)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 81. `milestone-levels` (Milestone Levels)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 82. `missing-pet-notifier` (Missing Pet Notifier)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 83. `more-fireworks` (More Fireworks)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 87. `npc-contact-filter` (Npc Contact Filter)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 89. `osrs-wiki-crowdsourcing` (Osrs Wiki Crowdsourcing)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 94. `pet-spell-blocker` (Pet Spell Blocker)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 95. `placeholders-warning` (Placeholders Warning)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 96. `player-outline` (Player Outline)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
* **GitHub Repository:** [https://github.com/Adam-/runelite-plugins](https://github.com/Adam-/runelite-plugins)
...
### 99. `potion-storage-bars` (Potion Storage Bars)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 101. `purchase-progress` (Purchase Progress)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 103. `qol-interfaces` (Qol Interfaces)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 105. `random-event-hider` (Random Event Hider)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 106. `recolored-herb-seeds` (Recolored Herb Seeds)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 107. `rich-text-notes` (Rich Text Notes)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 108. `runepouch-loadouts` (Runepouch Loadouts)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 112. `scrollboxcounter` (Scrollboxcounter)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 114. `shortest-clue` (Shortest Clue)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 115. `shortest-path` (Shortest Path)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 116. `six-hour-reminder` (Six Hour Reminder)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 117. `skilling-boost-reminder` (Skilling Boost Reminder)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 118. `skills-tab-progress-bars` (Skills Tab Progress Bars)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 119. `slayer-task-sorter` (Slayer Task Sorter)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 122. `spawnpredictor` (Spawnpredictor)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 123. `spirit-tree-map` (Spirit Tree Map)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 124. `steps-per-clue` (Steps Per Clue)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 125. `target-true-tile` (Target True Tile)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 126. `tasks-tracker` (Tasks Tracker)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 128. `tick-fixer-for-mac` (Tick Fixer For Mac)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 130. `tictac7x-camera-pitch-limiter` (Tictac7x Camera Pitch Limiter)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 136. `time-tracking-reminder` (Time Tracking Reminder)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 137. `tool-required` (Tool Required)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 138. `turning-circles` (Turning Circles)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 139. `unbalanced-trade-prevention` (Unbalanced Trade Prevention)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 140. `unresponsive-cursor` (Unresponsive Cursor)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 141. `valuable-drop-recolor` (Valuable Drop Recolor)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 142. `wasted-bank-space` (Wasted Bank Space)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 143. `watson-clue-tracker` (Watson Clue Tracker)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 144. `what-pet-is-that-anyway` (What Pet Is That Anyway)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 1. `autocast-utilities` (Autocast Utilities)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
### 2. `lite-regen-meter` (Lite Regen Meter)
* **Active Profiles:** `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Raids - ToA`, `Slayer`, `Questing`, `default`, `Wilderness`, `Bossing`
...
## 🐉 3. Bossing Profile Exclusives (`Bossing-5.properties` - 0 Plugins)
---
...
## Tombs of Amascut (`Raids - ToA-2.properties` - 0 Plugins)
## Chambers of Xeric (`Raids - CoX-3.properties` - 0 Plugins)
## Theatre of Blood (`Raids - ToB-4.properties` - 1 Plugins)
---

## 🔨 6. Skilling & Minigames Exclusives (`Skilling & Minigames-6.properties` - 0 Plugins)
---

## 💀 7. Wilderness & PvP Exclusives (`Wilderness-8.properties` - 0 Plugins)
