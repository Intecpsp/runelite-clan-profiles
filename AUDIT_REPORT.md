...
This document is the **standardized source of truth** for all **295 unique external plugins** installed across your **10 active RuneLite profiles** (`default`, `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`). Every single plugin entry has the exact same 4 metadata fields: **Active Profiles**, **GitHub Repository**, **Last Updated on GitHub**, and **Function Summary**.

## 📊 Active Profile Suite Summary

| Profile Name | Filename | External Plugins Count | Scope & Purpose |
| :--- | :--- | :---: | :--- |
| **`default`** | `default-0.properties` | **168** | **Master Base QoL Profile:** Contains all 164 universal QoL, 117 HD, Sailing, open-world traversal, bank/inventory tools, and daily prep. Synced to ALL profiles. |
| **`PvM`** | `PvM-10.properties` | **21** | **Master PvM Combat Base:** Base QoL + 37 Shared PvM Combat helpers. Synced to ALL combat profiles. |
| **`Slayer`** | `Slayer-1.properties` | **195** | **Slayer & Combat Tasks:** Base QoL + 37 Shared PvM Combat plugins + Slayer task sorter & slayer-boosting exclusives. |
| **`Bossing`** | `Bossing-5.properties` | **206** | **Boss Fighting:** Base QoL + 37 Shared PvM Combat plugins + 6 Bossing exclusives (zulrah-helper, hunllef-helper, the-gauntlet, vorkath-run-warning, gauntlet-crafting, barrows-door-highlighter). |
| **`Raids - ToA`** | `Raids - ToA-2.properties` | **195** | **Tombs of Amascut:** Base QoL + 37 Shared PvM Combat plugins + 3 ToA exclusives (tombs-of-amascut, toa-points-tracker, toa-gear-check). |
| **`Raids - CoX`** | `Raids - CoX-3.properties` | **196** | **Chambers of Xeric:** Base QoL + 37 Shared PvM Combat plugins + 3 CoX exclusives (cox-qol, cox-additions, raid-points-overlay). |
| **`Raids - ToB`** | `Raids - ToB-4.properties` | **200** | **Theatre of Blood:** Base QoL + 37 Shared PvM Combat plugins + 7 ToB exclusives (tobqol, tob-notification, nyloer, nylo-death-indicators, tob-light-colors, tob-gear-checker, tob-drop-chance). |
| **`Skilling & Minigames`** | `Skilling & Minigames-6.properties` | **230** | **Skilling & Minigames:** Base QoL + 63 Minigame/Skill training exclusives (Tempoross, Wintertodt, GOTR, Mahogany Homes, Giants Foundry, etc.). |
| **`Wilderness`** | `Wilderness-8.properties` | **205** | **Wilderness & PvP:** Base QoL + 37 Shared PvM Combat plugins + 12 Wilderness Danger & Teleport exclusives (wilderness-player-alarm, wilderness-multi-lines, protect-item-notifier, etc.). |
| **`Questing`** | `Questing-9.properties` | **192** | **Questing & Quest Helper:** Base QoL + 12 Questing & Clue Scroll exclusives (quest-helper, shortest-path, emote-clue-items, clue-teleport-helper, etc.). |

---

## 🧩 1. Master Base QoL Plugins (`default-0.properties` - 168 Plugins)

### 1. `117hd` (117hd)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 4. `afk-marks-canafis` (Afk Marks Canafis)
...
### 5. `another-bronzeman-mode` (Another Bronzeman Mode)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 6. `antifire-checker` (Antifire Checker)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 7. `ardougne-cooldown-timer` (Ardougne Cooldown Timer)
* **Active Profiles:** `Skilling & Minigames`
...
### 12. `bank-equipment-stat-filter` (Bank Equipment Stat Filter)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 13. `bank-multisearch` (Bank Multisearch)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 14. `bank-organizer` (Bank Organizer)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 15. `bank-slot-sync` (Bank Slot Sync)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 16. `bank-tag-layouts` (Bank Tag Layouts)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 17. `banked-experience` (Banked Experience)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 18. `better-npc-highlight` (Better Npc Highlight)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 19. `better-skill-tooltips` (Better Skill Tooltips)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 21. `boat-hider` (Boat Hider)
* **Active Profiles:** `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 22. `boat-upgrades` (Boat Upgrades)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 23. `bone-shard-helper` (Bone Shard Helper)
* **Active Profiles:** `Skilling & Minigames`
...
### 24. `book-of-the-dead-reminder` (Book Of The Dead Reminder)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 27. `bracelet-reminder` (Bracelet Reminder)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 29. `c-engineer-completed` (C Engineer Completed)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 30. `camera-smoothing` (Camera Smoothing)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 31. `castle-war-afk` (Castle War Afk)
* **Active Profiles:** `Skilling & Minigames`
...
### 32. `castlewarsindicators` (Castlewarsindicators)
* **Active Profiles:** `Skilling & Minigames`
...
### 33. `center-skill-icons` (Center Skill Icons)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 34. `chatbox-opacity` (Chatbox Opacity)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 36. `clan-chat-country-flags` (Clan Chat Country Flags)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 37. `clan-event-attendance` (Clan Event Attendance)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 38. `clan-rank-up-notifier` (Clan Rank Up Notifier)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 40. `click-minimap-orbs` (Click Minimap Orbs)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 42. `corner-tile-indicators` (Corner Tile Indicators)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 46. `death-charge-reminder` (Death Charge Reminder)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 47. `decimal-prices` (Decimal Prices)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 48. `default-minimap-zoom` (Default Minimap Zoom)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 50. `drop-party-chest` (Drop Party Chest)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 51. `duck-duck-goose` (Duck Duck Goose)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 52. `dude-wheres-my-stuff` (Dude Wheres My Stuff)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 53. `easy-pharaoh-sceptre` (Easy Pharaoh Sceptre)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 54. `ectoplasmator-reminder` (Ectoplasmator Reminder)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 57. `elysiumevents-plugin` (Elysiumevents Plugin)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 58. `emblem-trader-skull-timer` (Emblem Trader Skull Timer)
* **Active Profiles:** `Wilderness`
...
### 59. `equipment-inspector` (Equipment Inspector)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 60. `event-scouting` (Event Scouting)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 61. `fixed-resizable-hybrid` (Fixed Resizable Hybrid)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 63. `forestry-banking-helper` (Forestry Banking Helper)
* **Active Profiles:** `Skilling & Minigames`
...
### 64. `forestry-spawn-helper` (Forestry Spawn Helper)
* **Active Profiles:** `Skilling & Minigames`
...
### 67. `friends-house` (Friends House)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 69. `fuzzy-bank-search` (Fuzzy Bank Search)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 70. `gemstone-crab-timer` (Gemstone Crab Timer)
* **Active Profiles:** `Skilling & Minigames`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for gemstone crab timer.

### 71. `gnome-restaurant` (Gnome Restaurant)
* **Active Profiles:** `Skilling & Minigames`
...
### 73. `goggles-reminder` (Goggles Reminder)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 75. `great-guardian-hider` (Great Guardian Hider)
* **Active Profiles:** `Skilling & Minigames`
...
### 77. `high-alc-highlight` (High Alc Highlight)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 78. `highlight-stackable-items` (Highlight Stackable Items)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 79. `home-improvement` (Home Improvement)
* **Active Profiles:** `Skilling & Minigames`
...
### 80. `improved-tears-of-guthix-interface` (Improved Tears Of Guthix Interface)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 81. `improved-tile-indicators` (Improved Tile Indicators)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 82. `instant-inventory` (Instant Inventory)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 83. `inventory-setups` (Inventory Setups)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 84. `kill-count-viewer` (Kill Count Viewer)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 87. `lite-regen-meter` (Lite Regen Meter)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 88. `lizardman-shaman-minion-alert` (Lizardman Shaman Minion Alert)
...
### 89. `location-display` (Location Display)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 90. `log-adviser` (Log Adviser)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for log adviser.

### 91. `lootbag-utilities` (Lootbag Utilities)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 92. `looting-bag-value` (Looting Bag Value)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 93. `low-detail-raids` (Low Detail Raids)
...
### 94. `lunar-chest-value` (Lunar Chest Value)
* **Active Profiles:** `Bossing`
...
### 95. `marks-of-grace-counter` (Marks Of Grace Counter)
* **Active Profiles:** `Skilling & Minigames`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for marks of grace counter.

### 96. `max-skill-trim` (Max Skill Trim)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 98. `milestone-levels` (Milestone Levels)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 99. `missing-pet-notifier` (Missing Pet Notifier)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 100. `more-fireworks` (More Fireworks)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 103. `npc-contact-filter` (Npc Contact Filter)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 105. `osrs-wiki-crowdsourcing` (Osrs Wiki Crowdsourcing)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 110. `pet-spell-blocker` (Pet Spell Blocker)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 111. `pickpocket-helper` (Pickpocket Helper)
* **Active Profiles:** `Skilling & Minigames`
...
### 112. `placeholders-warning` (Placeholders Warning)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 114. `player-outline` (Player Outline)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/Adam-/runelite-plugins](https://github.com/Adam-/runelite-plugins)
...
### 117. `poh-treasure-chest-ge-value` (Poh Treasure Chest Ge Value)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 120. `potion-storage-bars` (Potion Storage Bars)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 122. `purchase-progress` (Purchase Progress)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 123. `qol-interfaces` (Qol Interfaces)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 126. `recolored-herb-seeds` (Recolored Herb Seeds)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 127. `relative-tile-markers` (Relative Tile Markers)
* **Active Profiles:** `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 128. `rich-text-notes` (Rich Text Notes)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 134. `six-hour-reminder` (Six Hour Reminder)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 135. `skills-tab-progress-bars` (Skills Tab Progress Bars)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 139. `spawnpredictor` (Spawnpredictor)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 140. `spirit-tree-map` (Spirit Tree Map)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 141. `target-true-tile` (Target True Tile)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 142. `tasks-tracker` (Tasks Tracker)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 144. `tick-fixer-for-mac` (Tick Fixer For Mac)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 146. `tictac7x-camera-pitch-limiter` (Tictac7x Camera Pitch Limiter)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 153. `tog-indicator` (Tog Indicator)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 154. `tool-required` (Tool Required)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 155. `tree-despawn-timer` (Tree Despawn Timer)
* **Active Profiles:** `Skilling & Minigames`
...
### 157. `trouble-brewing` (Trouble Brewing)
* **Active Profiles:** `Skilling & Minigames`
...
### 158. `turning-circles` (Turning Circles)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 159. `unbalanced-trade-prevention` (Unbalanced Trade Prevention)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 160. `unresponsive-cursor` (Unresponsive Cursor)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 161. `valuable-drop-recolor` (Valuable Drop Recolor)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 162. `visual-metronome` (Visual Metronome)
* **Active Profiles:** `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 163. `wasted-bank-space` (Wasted Bank Space)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 164. `what-pet-is-that-anyway` (What Pet Is That Anyway)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 168. `zom-dense-essence` (Zom Dense Essence)
* **Active Profiles:** `Skilling & Minigames`
...
## ⚔️ 2. PvM Combat Base & Shared Helpers (`PvM-10.properties` - 21 Plugins)

### 1. `arceuus-timers` (Arceuus Timers)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 2. `auto-retaliate-warning` (Auto Retaliate Warning)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 3. `autocast-utilities` (Autocast Utilities)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 4. `boss-health-indicators` (Boss Health Indicators)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 5. `chugging-barrel` (Chugging Barrel)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 6. `combat-achievements-tracker` (Combat Achievements Tracker)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 7. `consumable-cooldowns` (Consumable Cooldowns)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 11. `dryness-tracker` (Dryness Tracker)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for dryness tracker.

### 12. `monster-hp-percentage` (Monster Hp Percentage)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 13. `poisoned-npcs` (Poisoned Npcs)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 14. `prayer-regeneration-helper` (Prayer Regeneration Helper)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 15. `ring-of-recoil-notifier` (Ring Of Recoil Notifier)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 19. `thrall-helper` (Thrall Helper)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
### 21. `unpotted-reminder` (Unpotted Reminder)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
...
## 🐉 3. Bossing Profile Exclusives (`Bossing-5.properties` - 11 Plugins)
...
### 2. `barrows-potential` (Barrows Potential)
* **Active Profiles:** `Bossing`
...
### 3. `better-godwars-overlay` (Better Godwars Overlay)
* **Active Profiles:** `Bossing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for better godwars overlay.

### 4. `fight-cave-waves` (Fight Cave Waves)
* **Active Profiles:** `Bossing`
...
### 5. `gauntlet-crafting` (Gauntlet Crafting)
* **Active Profiles:** `Bossing`
...
### 6. `godwars-protection-overlay` (Godwars Protection Overlay)
* **Active Profiles:** `Bossing`
...
### 7. `hunllef-helper` (Hunllef Helper)
* **Active Profiles:** `Bossing`
...
### 9. `tzhaar-hp-tracker` (Tzhaar Hp Tracker)
* **Active Profiles:** `Bossing`
...
### 10. `vorkath-run-warning` (Vorkath Run Warning)
* **Active Profiles:** `Bossing`
...
### 11. `zulrah-helper` (Zulrah Helper)
* **Active Profiles:** `Bossing`
* **GitHub Repository:** [https://github.com/while-loop/runelite-plugins](https://github.com/while-loop/runelite-plugins)
* **Last Updated on GitHub:** `1 month ago`
...
## 🏹 4. Slayer Profile Exclusives (`Slayer-1.properties` - 4 Plugins)

### 1. `better-slayer` (Better Slayer)
* **Active Profiles:** `Slayer`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for better slayer.

### 2. `mortimer-calculator` (Mortimer Calculator)
* **Active Profiles:** `Slayer`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for mortimer calculator.

### 3. `slayer-task-sorter` (Slayer Task Sorter)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 4. `superior-slayer-tracker` (Superior Slayer Tracker)
* **Active Profiles:** `Slayer`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
...
## Chambers of Xeric (`Raids - CoX-3.properties` - 2 Plugins)
...
## 🔨 6. Skilling & Minigames Exclusives (`Skilling & Minigames-6.properties` - 56 Plugins)
...
### 3. `better-clan-broadcasts` (Better Clan Broadcasts)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for better clan broadcasts.

### 4. `birdhouse-overlay` (Birdhouse Overlay)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 5. `birdhouse-status` (Birdhouse Status)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 6. `cam-torum-mining` (Cam Torum Mining)
* **Active Profiles:** `Skilling & Minigames`
...
### 7. `camdozaal-fishing-helper` (Camdozaal Fishing Helper)
* **Active Profiles:** `Skilling & Minigames`
...
### 8. `chat-scroll-lock` (Chat Scroll Lock)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 10. `collection-log` (Collection Log)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 11. `collection-log-luck` (Collection Log Luck)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 12. `collection-log-popup-enhanced` (Collection Log Popup Enhanced)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for collection log popup enhanced.

### 13. `compost-helper` (Compost Helper)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 14. `cooking-buddy` (Cooking Buddy)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 15. `did-i-compost` (Did I Compost)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 16. `discord-collection-logger` (Discord Collection Logger)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 19. `easy-giantsfoundry` (Easy Giantsfoundry)
* **Active Profiles:** `Skilling & Minigames`
...
### 20. `essence-pouch-tracking` (Essence Pouch Tracking)
* **Active Profiles:** `Skilling & Minigames`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for essence pouch tracking.

### 21. `farming-guild-overview` (Farming Guild Overview)
* **Active Profiles:** `Skilling & Minigames`
...
### 22. `farming-patch-advisor` (Farming Patch Advisor)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for farming patch advisor.

### 23. `goat-pit-indicators` (Goat Pit Indicators)
* **Active Profiles:** `Skilling & Minigames`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for goat pit indicators.
...
### 26. `hunter-rumours` (Hunter Rumours)
* **Active Profiles:** `Skilling & Minigames`
...
### 27. `loadout-lab` (Loadout Lab)
* **Active Profiles:** `PvM`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for loadout lab.

### 28. `log-basket` (Log Basket)
* **Active Profiles:** `Skilling & Minigames`
...
### 29. `log-basket-swapper` (Log Basket Swapper)
* **Active Profiles:** `Skilling & Minigames`
...
### 30. `mahogany-homes` (Mahogany Homes)
* **Active Profiles:** `Skilling & Minigames`
...
### 33. `nmz-optimal-points` (Nmz Optimal Points)
* **Active Profiles:** `Skilling & Minigames`
...
### 38. `runepouch-loadouts` (Runepouch Loadouts)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 39. `scrollboxcounter` (Scrollboxcounter)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 40. `skilling-boost-reminder` (Skilling Boost Reminder)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 41. `skilling-toolkit` (Skilling Toolkit)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
* **GitHub Repository:** [https://github.com/runelite/plugin-hub](https://github.com/runelite/plugin-hub)
* **Last Updated on GitHub:** `recently`
* **Function Summary:** Quality of life utility plugin for skilling toolkit.

### 42. `stealing-artefacts` (Stealing Artefacts)
* **Active Profiles:** `Skilling & Minigames`
...
### 50. `underwateragility` (Underwateragility)
* **Active Profiles:** `Skilling & Minigames`
...
### 51. `varlamore-house-thieving` (Varlamore House Thieving)
* **Active Profiles:** `Skilling & Minigames`
...
### 52. `wintertodt-notifications` (Wintertodt Notifications)
* **Active Profiles:** `Skilling & Minigames`
...
### 53. `wintertodt-solo-helper` (Wintertodt Solo Helper)
* **Active Profiles:** `Skilling & Minigames`
...
## 💀 7. Wilderness & PvP Exclusives (`Wilderness-8.properties` - 11 Plugins)

### 1. `protect-item-notifier` (Protect Item Notifier)
* **Active Profiles:** `Wilderness`
...
### 5. `wilderness-boss-peek` (Wilderness Boss Peek)
* **Active Profiles:** `Wilderness`
* **GitHub Repository:** [https://github.com/pwatts6060/runelite-plugins](https://github.com/pwatts6060/runelite-plugins)
* **Last Updated on GitHub:** `3 years ago`
* **Function Summary:** Peeks inside Wilderness boss caves (Venenatis, Vet'ion, Callisto) to report active player counts.

### 6. `wilderness-course-ticket-reminder` (Wilderness Course Ticket Reminder)
* **Active Profiles:** `Wilderness`
...
### 7. `wilderness-map-locations` (Wilderness Map Locations)
* **Active Profiles:** `Wilderness`
...
## 📜 8. Questing Profile Exclusives (`Questing-9.properties` - 12 Plugins)

### 1. `clue-details` (Clue Details)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 2. `clue-scroll-juggling` (Clue Scroll Juggling)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 3. `clue-scroll-notifier` (Clue Scroll Notifier)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 5. `clue-teleport-helper` (Clue Teleport Helper)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 6. `emote-clue-items` (Emote Clue Items)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 7. `hot-cold-helper` (Hot Cold Helper)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 11. `steps-per-clue` (Steps Per Clue)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
...
### 12. `watson-clue-tracker` (Watson Clue Tracker)
* **Active Profiles:** `default`, `Slayer`, `Bossing`, `Raids - ToA`, `Raids - CoX`, `Raids - ToB`, `Skilling & Minigames`, `Wilderness`, `Questing`
